...
| Dossier | Rôle | État |
|---|---|---|
| [System/](System/README.md) | système de base : paquets, nom d'hôte, fuseau, swap, journaux, cron, diagnostics disque, mémoire et services, notification d’échec | 11 scripts |
