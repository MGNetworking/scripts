...
implementation_notes:
  ...
  - require_cmd helm kubectl timeout ; tout appel kubectl porte --request-timeout ; stderr capturé à part de stdout ; distinguer NotFound, Forbidden, API injoignable et kubeconfig invalide (messages distincts)
