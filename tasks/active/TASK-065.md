...
implementation_notes:
  - vérifié par l'orchestrateur sur https://cert-manager.io/docs/installation/helm/ le 2026-09-17 (l'agent n'a pas d'accès web, ne rien inventer au-delà) ; helm reçoit --timeout 5m (hook startupapicheck) sous un timeout externe plus long (330 s)
