...
Prochain identifiant libre : **TASK-100**.
...
| [TASK-066](completed/TASK-066.md) | Écrire `Kubernetes/Installation/install-metrics.sh` | `completed` | basse | 062 | conteneur `debian` | non |
...
| [TASK-083](completed/TASK-083.md) | Essai DeepSeek : lignes « Prouvé par : » des scripts qui restent en Bash | `completed` | moyenne | — | hôte | non |
...
| [TASK-099](pending/TASK-099.md) | Relecture lançable par l'API, interrupteur API ou abonnement | `ready` | haute | 098 | hôte | non |
| [TASK-094](active/TASK-094.md) | Vues manquantes d'`architecture.md` : exécution, couches, registre, capacités | `in_progress` | haute | — | hôte | non |
...
| Installation — plan §5 | [TASK-062](completed/TASK-062.md) à [TASK-066](completed/TASK-066.md) | vérification seule de kubectl, Traefik et metrics-server ; décision 48 |
