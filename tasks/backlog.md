...
| [TASK-066](active/TASK-066.md) | Écrire `Kubernetes/Installation/install-metrics.sh` | `in_progress` | basse | 062 | conteneur `debian` | non |
...
| Installation — plan §5 | [TASK-062](completed/TASK-062.md) à [TASK-066](active/TASK-066.md) | vérification seule de kubectl, Traefik et metrics-server ; décision 48 |
