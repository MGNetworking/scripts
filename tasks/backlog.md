...
| [TASK-051](active/TASK-051.md) | Écrire `Linux/K3s/install-k3s.sh` | `in_progress` | haute | 050 | conteneur `debian` | **oui** |
...
| `install-k3s.sh` | atomisée : [TASK-051](active/TASK-051.md) — décisions prises (décision 47) |
