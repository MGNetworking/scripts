...
Prochain identifiant libre : **TASK-087**.
...
| [TASK-086](pending/TASK-086.md) | Outiller la vérification et la clôture, branche documentaire de `juger.sh` (A172) | `ready` | haute | — | hôte | non |
